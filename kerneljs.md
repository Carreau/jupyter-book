...
Though, if you like to ship JavaScript with your kernel(s) and have it loaded when user switch to your kernel, or open a notebook working with your kernel, then you need to put a `kernel.js` file in the kernelspec folder of your kernel.
